...
var KTDialer = function (e, t) {
    var n = this;
    if (e) {
        var i = {min: null, max: null, step: 1, currency: !1, decimals: 0, prefix: "", suffix: ""}, r = function () {
...
var KTDrawerHandlersInitialized = !1, KTDrawer = function (e, t) {
    var n = this;
    if (null != e) {
        var i = {overlay: !0, direction: "end", baseClass: "drawer", overlayClass: "drawer-overlay"}, r = function () {
            ...
            var e = f(), t = p(), i = m("direction"), r = m("top"), o = m("bottom"), a = m("start"), s = m("end");
...
var KTEventHandler = function () {
    var e = {}, t = function (t, n, i, r) {
        var o = KTUtil.getUniqueId("event"), a = KTUtil.data(t).get(n);
    ...
    return {
        trigger: function (t, n, i) {
            return function (t, n, i) {
                var r, o = !0;
                if (!0 === KTUtil.data(t).has(n)) for (var a, l = KTUtil.data(t).get(n), s = 0; s < l.length; s++) if (a = l[s], e[n] && e[n][a]) {
                    var u = e[n][a];
            ...
            return function (t, n, i) {
                var r = KTUtil.data(t).get(n), o = r && r.indexOf(i);
...
var KTFeedback = function (e) {
    var t = this, n = {width: 100, placement: "top-center", content: "", type: "popup"}, i = function () {
...
var KTMenuHandlersInitialized = !1, KTMenu = function (e, t) {
    var n = this;
    if (null != e) {
        var i = {dropdown: {hoverTimeout: 200, zindex: 107}, accordion: {slideSpeed: 250, expand: !1}},
            r = function () {
                ...
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.show", e)) {
                    ...
                    c(e) || p(e);
                    var t = g(e), i = L(e, "width"), r = L(e, "height"), o = n.options.dropdown.zindex,
        ...
        !0 === KTUtil.data(e).has("menu") ? n = KTUtil.data(e).get("menu") : r(), n.click = function (e, t) {
            ...
            return function (e) {
                var t = T(e);
                if (t) {
                    var i = K(t), r = e.closest(".tab-pane"),
                    ...
                    if ("accordion" === v(t) ? A(t) : t.classList.add("here"), i && i.length > 0) for (var l = 0, s = i.length; l < s; l++) {
                        var u = i[l];
...
var KTScrollHandlersInitialized = !1, KTScroll = function (e, t) {
    var n = this;
    if (e) {
...
var KTScrolltop = function (e, t) {
    var n = this;
    if (null != e) {
        var i = {offset: 300, speed: 600}, r = function () {
...
var KTStickyHandlersInitialized = !1, KTSticky = function (e, t) {
    var n = this;
    if (null != e) {
        var i = {
            offset: 200,
            ...
            var t = u("top");
            t = t ? parseInt(t) : 0;
            var i = u("left"), r = u("right"), o = u("width"), a = u("zindex"), l = u("dependencies"), d = u("class"),
                c = s(), m = u("height-offset");
            ...
            var e = u("dependencies"), t = u("class");
...
var KTSwapperHandlersInitialized = !1, KTSwapper = function (e, t) {
    var n = this;
    if (null != e) {
...
var KTUtil = function () {
    ...
    return {
        init: function (e) {
            ...
            const i = e.offsetTop, r = i + e.clientHeight + n, o = t.scrollTop, a = o + t.clientHeight;
            return i >= o && r <= a
            ...
            var n = this.getViewPort().width, i = null;
            ...
            let t = e.getBoundingClientRect().left, n = e.getBoundingClientRect().top,
                i = Math.max(document.documentElement.clientWidth, window.innerWidth || 0),
                r = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), o = e.clientWidth,
                a = e.clientHeight;
    ...
    return {
        init: function () {
            ...
            (a = document.querySelector("#kt_app_engage"), s = document.querySelector("#kt_app_engage_toggle_on"), l = document.querySelector("#kt_app_engage_toggle_off"), u = document.querySelector("#kt_app_engage_prebuilts_modal"), a && u && (null !== u && "1" !== KTCookie.get("app_engage_prebuilts_modal_displayed") && setTimeout((function () {
                ...
                const e = u.querySelector('[data-kt-element="title"]'), t = u.querySelector('[data-kt-menu="true"]');
                KTUtil.on(u, "[data-kt-mode]", "click", (function (n) {
                    const i = this.innerText, r = this.getAttribute("data-kt-mode"),
                ...
                var o = $(e).serialize();
                $.ajax({
                    type: "POST", dataType: "html", url: n, data: o, success: function (e, t, n) {
                ...
                var o = $(e).serialize();
                $.ajax({
                    type: "POST", dataType: "html", url: n, data: o, success: function (e, t, i) {
                ...
                var r = $(e).serialize();
                $.ajax({
                    type: "POST", dataType: "html", url: n, data: r, success: function (e, t, n) {
                        history.scrollRestoration && (history.scrollRestoration = "manual"), location.reload()
                    }, error: function (e) {
                        toastr.error("Please try it again later.", "Something went wrong!", {
                            timeOut: 0,
...
var KTThemeModeUser = {
    init: function () {
        KTThemeMode.on("kt.thememode.change", (function () {
            var e = KTThemeMode.getMenuMode(), t = KTThemeMode.getMode();
...
var KTThemeMode = function () {
    var e, t = this, n = function () {
        ...
        var n = t.getAttribute("data-kt-value"), i = e.querySelector('.active[data-kt-element="mode"]');
        ...
        init: function () {
            e = document.querySelector('[data-kt-element="theme-mode-menu"]'), i(n(), r()), KTEventHandler.trigger(document.documentElement, "kt.thememode.init", t), e && [].slice.call(e.querySelectorAll('[data-kt-element="mode"]')).map((function (e) {
                e.addEventListener("click", (function (t) {
                    t.preventDefault();
                    var n = e.getAttribute("data-kt-value"), r = n;
                    "system" === n && (r = o()), i(r, n)
                }))
            }))
        }, getMode: function () {
